    ...
    >
      ...
      <defs>
        <linearGradient id="divider-grad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#A94E0F" stopOpacity="0" />
          <stop offset="30%" stopColor="#A94E0F" stopOpacity="0.15" />
          <stop offset="70%" stopColor="#6E3A12" stopOpacity="0.15" />
          <stop offset="100%" stopColor="#6E3A12" stopOpacity="0" />
        </linearGradient>
