...
export const SiteHeader = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-cream/90 backdrop-blur-sm border-b border-border/50 pt-[env(safe-area-inset-top)]">
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-cream/95 backdrop-blur-md lg:hidden pb-[env(safe-area-inset-bottom)]"
          >
